...
export default function Page() {
  ...
  const stats = [
    { value: 12.9, suffix: "mi", prefix: "US$", label: "é o custo médio anual por organização com problemas de qualidade de dados", source: "Gartner" },
    {
      ...
      suffix: "%",
      prefix: "",
      label: "das empresas não confiam na qualidade dos próprios dados",
    ...
    },
    {
      ...
      prefix: "",
      label:
        "mais retorno financeiro em empresas orientadas por dados vs concorrentes",
    ...
    },
    {
      ...
      suffix: "%",
      prefix: "",
      label: "dos projetos de IA falham por falta de dados bem estruturados",
      source: "MIT Sloan",
    },
  ];
    ...
    <main className="min-h-screen font-sans">
      ...
      <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-slate-900/70 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-18 flex items-center justify-between py-4">
          ...
          <a
            href="#contato"
            className="hidden lg:block border border-indigo-400/40 px-5 py-2 rounded-full text-indigo-300 text-sm hover:bg-indigo-500/10 hover:border-indigo-400 transition-all duration-200"
          >
            Fale Conosco
          </a>
        </div>
      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-slate-950 via-[#0B1730] to-[#081326] overflow-hidden pt-20">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-32 text-center">
          ...
          >
            ...
            <span className="text-indigo-300 text-xs tracking-widest uppercase">
              Consultoria de Dados & IA
            </span>
          </div>
          ...
          >
            Transformamos dados dispersos em decisões precisas — com estratégia,
            tecnologia e visão de negócio.
          </p>
      ...
      <section className="py-24 px-6 bg-slate-950 border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <Reveal className="text-center mb-16">
            <span className="uppercase tracking-[0.3em] text-sm text-indigo-400">
              O problema é real
            </span>
            ...
            <p className="mt-4 text-slate-400 max-w-xl mx-auto">
              Dados de institutos globais mostram o impacto financeiro direto da
              má gestão de dados nas empresas.
            </p>
          </Reveal>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((s, i) => (
              ...
              >
                ...
                <span className="text-xs text-indigo-400/70 font-medium tracking-wide">
                  Fonte: {s.source}
                </span>
              </Reveal>
            ))}
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <Reveal delay={150} className="lg:col-span-7 space-y-6">
              <p className="text-xl leading-relaxed text-gray-700">
                A Alcina Dados & IA nasceu da combinação entre experiência
                técnica de alto nível e visão prática de negócios.
              </p>
              <p className="text-lg leading-relaxed text-gray-600">
                Somos uma consultoria especializada em dados e inteligência
                artificial, formada por profissionais com atuação em projetos de
                alta complexidade nos setores financeiro, industrial e
                varejista.
              </p>
              <p className="text-lg leading-relaxed text-gray-600">
                Não acreditamos em soluções genéricas. Cada organização possui
                sua própria realidade, seus desafios e seus objetivos. Por isso,
                construímos estratégias sob medida que conectam tecnologia às
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto">
          <Reveal className="text-center mb-16">
            <span className="uppercase tracking-[0.3em] text-sm text-indigo-300">
              Soluções
            </span>
            <h2 className="mt-4 text-4xl md:text-5xl font-bold text-white">
              Nossos Serviços
            ...
            <p className="mt-6 max-w-2xl mx-auto text-slate-400 text-lg">
              Estruturamos dados, processos e inteligência artificial para
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-[#050B16] to-[#081326]">
        <div className="max-w-5xl mx-auto">
          <Reveal className="text-center mb-16">
            <span className="uppercase tracking-[0.3em] text-sm text-teal-400">
              Infraestrutura
            </span>
            ...
            <p className="mt-4 text-slate-400 max-w-xl mx-auto">
              Monitoramos cada camada do seu pipeline — da ingestão bruta até os
            ...
            {[
              {
                step: "01",
                title: "Diagnóstico",
                desc: "Mapeamos o estado atual dos seus dados, sistemas e processos.",
              },
              {
                step: "02",
                title: "Estratégia",
                desc: "Desenhamos o roadmap técnico alinhado ao seu negócio.",
              },
              {
                step: "03",
                title: "Execução",
                desc: "Implementamos as soluções com sua equipe, de forma ágil.",
              },
              {
                step: "04",
                title: "Evolução",
                desc: "Monitoramos, ajustamos e evoluímos continuamente.",
              },
            ].map((item, i) => (
              <Reveal key={i} delay={i * 100} className="relative">
                {i < 3 && (
                  <div
                    className="hidden md:block absolute top-8 left-full w-full h-px bg-gray-200 -translate-y-px z-0"
      ...
      <section
        id="contato"
        className="py-24 px-6 bg-gradient-to-b from-[#081326] to-slate-950"
      >
        <div className="max-w-xl mx-auto">
          <Reveal className="text-center mb-10">
            ...
            <p className="mt-4 text-slate-400 text-lg">
              Preencha abaixo e um especialista entrará em contato para entender
              seu contexto.
            </p>
          </Reveal>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="gov" className="bg-slate-800">
                      Governança e qualidade de dados
                    </option>
                    <option value="eng" className="bg-slate-800">
                      Pipelines e engenharia de dados
                    </option>
                    <option value="ia" className="bg-slate-800">
                      Implementação de IA / Machine Learning
                    </option>
                    <option value="bi" className="bg-slate-800">
                      Dashboards e Analytics
                    </option>
                    <option value="out" className="bg-slate-800">
                      Outro
                    </option>
                  </select>
                </div>
        ...
        >
          ...
          >
            ...
            <p className="text-slate-400 leading-relaxed mb-8">
              Em breve um especialista da Alcina entrará em contato para
              entender melhor o seu contexto e apresentar o diagnóstico.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <Image
                ...
                height={32}
              />
              <span className="text-white font-light tracking-[0.2em]">
                ALCINA
              </span>
            </div>
            <p className="text-sm leading-relaxed max-w-xs">
              Consultoria especializada em Dados & IA para empresas que querem
          ...
          <div>
            ...
            {[
              {
                label: "LinkedIn",
                href: "https://www.linkedin.com/company/alcina-dados-ia",
                icon: (
                  <svg
